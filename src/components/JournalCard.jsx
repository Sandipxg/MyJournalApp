  ...
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-4 shadow-sm flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div className="min-w-0">
        <p className="text-xs text-gray-400 mb-0.5">#{journal.id}</p>
      ...
      <div className="flex gap-2 shrink-0">
        ...
        <button
          ...
          className="flex-1 sm:flex-none text-sm px-3 py-2 rounded-lg border border-purple-300 text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900 transition-colors"
        >
          Edit
        </button>
        <button
          onClick={() => deleteJournal(journal.id)}
          className="flex-1 sm:flex-none text-sm px-3 py-2 rounded-lg border border-red-300 text-red-500 hover:bg-red-50 dark:hover:bg-red-900 transition-colors"
        >
          Delete
        </button>
      </div>
